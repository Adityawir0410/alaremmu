...
import 'onboardsecond_screen.dart';
            ...
            Row(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Icon(Icons.circle, size: 10, color: Color(0xFF168AAD)), // Active dot
                    SizedBox(width: 8),
                    Icon(Icons.circle, size: 8, color: Colors.grey), // Inactive dot
                    SizedBox(width: 8),
                    Icon(Icons.circle, size: 8, color: Colors.grey), // Inactive dot
                  ],
                ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => OnboardSecondScreen()),
                    );
                  },
